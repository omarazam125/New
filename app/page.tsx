  ...
  return (
    <div className="h-screen flex flex-col bg-background w-full">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <div className="mb-6">
          <h1 className="font-sans text-3xl font-bold text-foreground">Almoayyed Customer Service Dashboard</h1>
          <p className="mt-1 font-sans text-sm text-muted-foreground">
            Real-time insights from Almoayyed customer service and technical support
          </p>
        </div>
        ...
        <div className="mb-6 grid gap-6 md:grid-cols-3">
          ...
          <StatCard title="Transfer to Customer Service" value="89" description="In queue" icon={PhoneIncoming} />
        </div>
